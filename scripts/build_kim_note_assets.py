...
SECTIONS = [
    dict(
        ...
        narration_shots=[
            (f"{CORR_DAWN}, 인물 없이 복도 전체를 비추는 정적인 와이드 샷, 문고리에 걸린 흰 무지 봉지, "
        ...
        lines=[
            ...
            (A, "5", f"{CORR_DAWN}, 문이 손가락 하나 폭만큼 열리고 문틈 사이로 보이는 {JUNHO}의 "
                     f"경계하는 어두운 눈 익스트림 클로즈업, {MUTE}", [REF_JUNHO]),
    ...
    dict(
        ...
        lines=[
            ...
            (A, "5", f"{GUARD_IN}, 낡은 꽃무늬 수첩을 펴는 {KIM}의 주름진 손 클로즈업(수첩 속은 "
                     f"백지, 글자 없음), {MUTE}", [REF_KIM]),
    ...
    dict(
        ...
        narration_shots=[
            (f"{CORR}, 오후의 빛이 기운 복도, 문고리에 그대로 걸려 있는 흰 무지 봉지 클로즈업, "
             f"사람이 한 명도 없는 무인 장면, 인물 없음, {MUTE}", []),
        ],
        speaker_shots={
    ...
    dict(
        ...
        narration_shots=[
            (f"{CORR_DAWN}, {KIM}의 손이 흰 무지 봉지를 문고리에 거는 클로즈업, 매주 반복되는 "
             f"수요일의 몽타주 느낌, {MUTE}", [REF_KIM]),
        ],
        speaker_shots={
        ...
        lines=[
            ...
            (A, "5", f"손가락 하나 폭의 문틈 사이로 보이는 시점 샷, {CORR_DAWN} 저편으로 멀어지는 "
                     f"{KIM}의 제복 입은 뒷모습, {MUTE}", [REF_KIM_BACK]),
    ...
    dict(
        ...
        narration_shots=[
            (f"{CORR_DAWN}, 아무것도 걸려 있지 않은 텅 빈 은색 문고리를 향해 천천히 다가가는 "
             f"클로즈업, 사람이 한 명도 없는 무인 장면, 인물 없음, {MUTE}", []),
        ],
        speaker_shots={
            ...
            K: [(f"{GUARD_IN}, 이마의 물수건이 흘러내리는 채 몸을 일으킨 {KIM}가 믿기지 않는 "
                 f"놀란 표정으로 {TALK}", [REF_KIM])],
        },
        lines=[
            ...
            (A, "5", f"{GUARD_IN}, 이마에 접은 물수건을 얹고 간이침대에 누워 앓는 {KIM}, "
        ...
        speaker_shots={
            JH: [(f"{GUARD_IN}, 낡은 종이 상자를 품에 안은 {JUNHO}가 시선을 내린 채 낮고 느리게 "
                 ...
                 (f"{GUARD_IN}, 눈물이 고인 채 웃으려 애쓰는 {JUNHO}가 떨리는 목소리로 {TALK}",
                  [REF_JUNHO])],
            K: [(f"{GUARD_IN}, 바랜 쪽지를 오래 바라보는 {KIM}, 눈시울이 붉어진 채 낮은 목소리로 "
                 f"{TALK}", [REF_KIM]),
                (f"{GUARD_IN}, {KIM}가 시선을 들어 담담하지만 무겁게 {TALK}", [REF_KIM])],
        },
        lines=[
            (A, "5", f"{GUARD_IN}, {JUNHO}가 탁자 위에서 낡은 종이 상자를 여는 하이 앵글 클로즈업, "
                     f"상자 안에 무지 쪽지들이 가득, {MUTE}", [REF_JUNHO]),
    ...
    dict(
        ...
        speaker_shots={
            JH: [(f"{APT} 경비실 앞, {JUNHO_SUIT}가 처음으로 밝고 또렷한 표정으로 {TALK}",
                  [REF_JUNHO_SUIT])],
        ...
        lines=[
            ...
            (A, "10", f"{APT} 경비실 앞, {JUNHO_SUIT}가 {KIM}에게 허리 숙여 꾸벅 인사하고 {KIM}가 "
                      f"그의 어깨를 가볍게 툭 두드리는 장면, 화면에는 정확히 두 명만 등장, {MUTE}",
            ...
            (A, "5", f"{APT} 길, {JIWOO}가 환하게 손을 흔들고 {PARK}이 반찬통 몇 개를 안고 걸어오는 "
                     f"장면, 화면에는 정확히 두 명만 등장, {MUTE}", [REF_JIWOO, REF_PARK]),
            (A, "5", f"{GUARD_IN}, 꽃무늬 수첩에 펜으로 쓰는 {KIM}의 주름진 손 탑다운 클로즈업"
                     f"(페이지는 백지, 글자 없음), {MUTE}", [REF_KIM]),
            (A, "5", f"{GUARD_IN} 책상 위에 펼쳐진 꽃무늬 수첩의 백지 페이지 클로즈업, "
