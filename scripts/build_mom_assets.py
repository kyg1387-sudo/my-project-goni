...
OLD_GATE = "30년 전 초등학교 앞 등굣길(간판·현판·글자가 전혀 없는 무지 담벼락과 매끈한 교문 기둥), 비 내리는 아침, 아련한 세피아빛 회상 톤"
...
SECTIONS = [
    ...
    dict(
        ...
        ambience="",
        narration_shots=[
            shot(f"아무도 없는 {HOUSE}, 창밖으로 보이는 흐린 하늘과 흔들리는 빨랫줄, 사람이 한 명도 없는 빈 방, {MUTE}", []),
        ],
        speaker_shots={
            S_JR: [
    ...
    dict(
        ...
        lines=[
            ...
            (A, "5", f"{OLD_GATE}, 빗속에 붉은 경광등을 번쩍이는 흰색 구급차(차체와 배경에 글자·간판 전혀 없음), 그 앞 길바닥에 떨어진 젖은 노란 책가방 "
